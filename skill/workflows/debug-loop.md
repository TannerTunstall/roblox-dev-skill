...
Categorize the error into one of the following buckets. Cross-reference with `references/luau-language.md` and `references/networking-and-security.md` for common Roblox gotchas.
...
- **Fix pattern:** Move authority to the server. Validate every remote argument. See `references/networking-and-security.md`.
